...
btn1 = Button(frame_botones1, text="Lugar y fecha n.", command=abrir_ventana1)
btn1.place(x=20, y=70, width=100, height=30)

btn2 = Button(frame_botones1, text="inf. medica", command=abrir_ventana2)
btn2.place(x=140, y=70, width=100, height=30)

btn3 = Button(frame_botones1, text="inf. familiar", command=abrir_ventana3)
btn3.place(x=260, y=70, width=100, height=30)

btn4 = Button(frame_botones1, text="inf. Proceso edu", command=abrir_ventana4)
btn4.place(x=380, y=70, width=100, height=30)

btn5 = Button(frame_botones1, text="Info,amigos", command=abrir_ventana5)
...
btn6 = Button(frame_botones2, text="Inf. Hobbies", command=abrir_ventana6)
btn6.place(x=20, y=100, width=100, height=30)

btn7 = Button(frame_botones2, text="Inf. Horario esc", command=abrir_ventana7)
btn7.place(x=140, y=100, width=100, height=30)

btn8 = Button(frame_botones2, text="Prueba saber 2026", command=abrir_ventana8)
btn8.place(x=260, y=100, width=100, height=30)

btn9 = Button(frame_botones2, text="Proyeccion 2031", command=abrir_ventana9)
btn9.place(x=380, y=100, width=100, height=30)

btn10 = Button(frame_botones2, text="Libre", command=abrir_ventana10)
